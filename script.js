...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (yearbookContainer && searchInput) {
        const students = [
            ...
            { name: "Dr Akachi Nwaogu", facility: "Miraculous Grace Medical Centre", bio: "No 19 pipeline, Off Cele Bus Stop, Alagbole, Ogun State ", photo: "./maledoctor.jpg" },
            { name: "Dr Fatai O. Badmus", facility: "ÀTÌtọ́jú Ltd - Luxury Care Home for the Elderly", bio: "14 Alhaja Zainab Street, near Osaro Bus Stop, Akute.", photo: "./drfataibadmus.jpg" },  
        ];
